<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\cate\lst.html";i:1559015207;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1559270866;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559096276;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
         ...
         <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加栏目员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('cate/add'); ?>'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    '<?php echo url('cate/del',array('id'=>$vo['id'])); ?>')"
