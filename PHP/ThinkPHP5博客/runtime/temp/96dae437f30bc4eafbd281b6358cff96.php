<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\article\edit.html";i:1559202401;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1558515048;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559096276;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                   <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post"><!-- action为空 提交到当前add方法 去add方法查看-->
                                        <div class="form-group">
                                            <label for="title" class="col-sm-2 control-label no-padding-right">文章标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="title" name="title" type="text" value="<?php echo $article['title']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                 <input class="form-control" id="author" placeholder="author" name="author" value="<?php echo $article['author']; ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id" class="col-sm-2 control-label no-padding-right">文章关键字</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="keywords" placeholder="keywords" name="keywords" value="<?php echo $article['keywords']; ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input  id="pic" placeholder="pic" name="pic"  type="file" style="display: inline;">
                                                <?php if($article['pic'] != ''): ?>
                                                <img src="http://127.0.0.1/tp5/public/static<?php echo $article['pic']; ?>" height="50">
                                                <?php else: ?>暂无缩略图
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                                ...
                                                <select name="cateid">
                                                    ...
                                                    <?php if(is_array($cateres) || $cateres instanceof \think\Collection || $cateres instanceof \think\Paginator): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                        <option value="<?php echo $vo['id']; ?>" 
                                                            {if condition="$vo['id'] eq $article['cateid']"}
                                                            selected="selected"
                                                            /if}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <input class="checkbox-silder colored-darkorange" type="checkbox" name="state" id="state" <?php if($article['state'] == 1): ?> checked ="checked"<?php endif; ?>>
