<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\article\add.html";i:1559203820;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1559270866;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559096276;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
                        ...
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                ...
                                <section>
                                    <h2>
                                        <span class="profile">
                                            <span><?php echo \think\Request::instance()->session('username'); ?></span><!--读取session-->
                                        </span>
                                    </h2>
                                </section>
                            </a>
                                ...
                                <div id="horizontal-form">
                                   <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post"><!-- action为空 提交到当前add方法 去add方法查看-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                 <input class="form-control" id="author" placeholder="author" name="author"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id" class="col-sm-2 control-label no-padding-right">文章关键字</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="keywords" placeholder="keywords" name="keywords"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input  id="pic" placeholder="pic" name="pic"  type="file">
                                            </div>
                                        </div>
                                        <div class="form-group">
