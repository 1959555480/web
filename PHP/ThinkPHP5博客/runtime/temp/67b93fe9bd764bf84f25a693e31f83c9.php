<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\links\edit.html";i:1559010961;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1558515048;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559011366;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post"><!-- action为空 提交到当前add方法 去add方法查看-->
                                        <input type="hidden" name="id" value="<?php echo $Links['id']; ?>"><!--传送ID-->
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">链接名</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="title" name="title" value="<?php echo $Links['title']; ?>"  type="text"><!--edit方法中显示到这里，links是丢出来的数据-->
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                value="<?php echo $Links['url']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id" class="col-sm-2 control-label no-padding-right">链接描述</label>
                                            <div class="col-sm-6">
                                                 <textarea class="form-control" id="desc" placeholder="desc" name="desc"  type="text"
                                                value="<?php echo $Links['desc']; ?>"></textarea> 
                                            </div>
                                        </div>
