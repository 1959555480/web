<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\article\lst.html";i:1559201558;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1559270866;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559096276;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--vo可以随意变-->
                                            <tr>
                                                ...
                                                <td align="center">
                                                <?php if($vo['pic'] != ''): ?>
                                                    <img src="http://127.0.0.1/tp5/public/static<?php echo $vo['pic']; ?>" height="50">
                                                <?php else: ?>
                                                    <span>暂无缩略图</span>
                                                <?php endif; ?>
                                                </td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    '<?php echo url('article/del',array('id'=>$vo['id'])); ?>')"
