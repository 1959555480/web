...
<div class="hotmenu">
	...
	<div class="position"><a href='<?php echo url('index/index'); ?>'>主页</a> > <a href=''>生活</a> >  </div>
	...
	<div class="overall">
		...
		<div class="left">
			...
			<div class="xnews2">
				<div class="pic">
					<a target="_blank" href="20160920156279.html"><img src="<?php if($vo['pic'] != ''): ?> http://127.0.0.1/tp5/public/static<?php echo $vo['pic']; else: ?> http://127.0.0.1/tp5/public/static/index/images/guoqing.jpg<?php endif; ?>" alt="在家如何自制烤肉 烤肉串致癌不适宜多吃"/></a>
				</div>
				<div class="dec">
					<h3><a target="_blank" href="20160920156279.html"><?php echo $vo['title']; ?></a></h3>
