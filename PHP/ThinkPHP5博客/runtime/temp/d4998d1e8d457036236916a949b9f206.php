<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\cate\edit.html";i:1559015433;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1558515048;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559096276;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post"><!-- action为空 提交到当前add方法 去add方法查看-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="catename" placeholder="catename" name="catename" type="text" value="<?php echo $cate['catename']; ?>">
                                            </div>
