<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpStudy\PHPTutorial\WWW\tp5\public/../application/admin\view\admin\edit.html";i:1558772164;s:70:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\top.html";i:1559270627;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5\application\admin\view\common\left.html";i:1559096276;}*/ ?>
<!DOCTYPE html>
<html><head>
   <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post"><!-- action为空 提交到当前add方法 去add方法查看-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="username" name="username" value="<?php echo $admin['username']; ?>"  type="text"><!--edit方法中显示到这里，admin是丢出来的数据-->
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                 <input class="form-control" id="password" placeholder="password" name="password"  type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 不填设为默认</p>
                                        </div>  
                                        <div class="form-group">
