  ...
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">                  
                <VMulChooser :selections="versionList"
                  @on-change="onParamChange('versions', $event)"></VMulChooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
      ...
      <Dialog :is-show="isShowPayDialog" @onClose="hidePayDialog('isShowPayDialog')">
      ...
      <Dialog :is-show="isShowErrDialog" @onClose="hideErrDialog">
        支付失败！
      </Dialog>
...
import bankChooser from '../base/bankChooser'
...
export default {
  ...
  mounted(){
    this.buyNum = 1
    this.buyType.label = this.buyTypes[0].label
    this.period.label = this.periodList[0].label
  ...
  methods: {
    ...
    confirmBuy () {
      ...
      this.$axios.post('/api/createsOrder', reqParams)
      .then((res) => {
        ...
        console.log(this.isShowBuyDialog,this.isShowErrDialog)
      })
    },
    // buyMin(){
